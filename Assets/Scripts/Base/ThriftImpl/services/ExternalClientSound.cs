...
{
    public abstract class ExternalClientSound : Connector
    {
        ...
        public ExternalClientSound() : this(DEFAULT_THRIFT_HOST, DEFAULT_THRIFT_PORT)
        {
        }

        public ExternalClientSound(string host, int port) : base(host, port)
        {
            message = new Message();
