...
namespace autodeskcharacter.fapmapper
{
    ...
    public class Lip : FapMapper
    {
        ...
        public Lip(Transform faceBone, FAPType outerType, Vector3 directionAxis, FAPType outerType2,
            Vector3 directionAxis2, FAPType innerType, Vector3 rotationAxis) : base(faceBone)
        {
            axis1Type = outerType;
            direction1 = directionAxis;
            axis2Type = outerType2;
            direction2 = directionAxis2;
            this.innerType = innerType;
            this.rotationAxis = rotationAxis;

            position = faceBone.localPosition;
            orientinitial = faceBone.localRotation;
        }
        ...
        public override void applyFap(AnimationParametersFrame ff)
        {
            ...
            if (ff.getMask(innerType))
            {
                ...
                var q = Quaternion.AngleAxis(dist * magicNumber, rotationAxis);
    ...
    {
        private readonly Vector3 stretchDirection;

        private readonly FAPType stretchType;

        public MidLip(Transform faceBone, FAPType outerType, Vector3 directionAxis, FAPType outerType2,
            Vector3 directionAxis2, FAPType innerType, Vector3 rotationAxis, FAPType stretchType,
    ...
    public class Rotation : FapMapper
    {
        ...
        public Rotation(Transform faceBone, FAPType pitch, Vector3 pitchAxis, float amplitude1, FAPType yaw,
            Vector3 yawAxis, float amplitude2) : base(faceBone)
        {
            this.pitch = pitch;
        ...
        public override void applyFap(AnimationParametersFrame ff)
        {
            ...
            {
                var qx = Quaternion.AngleAxis(
                    ff.getValue(pitch) * amplitude1,
                    pitchAxis);

                var qy = Quaternion.AngleAxis(
    ...
    {
        public Eye(Transform faceBone, FAPType pitch, Vector3 pitchAxis, FAPType yaw, Vector3 yawAxis) : base(faceBone,
            pitch, pitchAxis, (float) (1.0 / 100000.0), yaw, yawAxis, (float) (1.0 / 100000.0))
        {
        }
    }
    ...
    public class TwoDOF : OneDOF
    {
        ...
        public TwoDOF(Transform faceBone, FAPType type1, Vector3 dir, FAPType type2, Vector3 dir2) : base(faceBone,
            type1, dir)
        {
            this.faceBone = faceBone;
            this.dir2 = dir2;
    ...
    public class Jaw : Rotation
    {
        ...
        public Jaw(Transform faceBone, FAPType pitch, Vector3 pitchAxis, float amplitude1, FAPType yaw, Vector3 yawAxis,
            float amplitude2, FAPType thrustType, Vector3 thrustDirection) : base(faceBone, pitch, pitchAxis,
            amplitude1, yaw, yawAxis, amplitude2)
        {
