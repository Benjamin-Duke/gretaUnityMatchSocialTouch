...
namespace autodeskcharacter.bapmapper
{
    public class BapMapper
    {
        ...
        public BapMapper(Transform bone, Quaternion correction)
        {
            ...
            if (correction != Quaternion.identity) preRotation = correction * preRotation;
        ...
        {
            return Quaternion.AngleAxis((float) (angle * 180 / Math.PI), axis);
        }
    }
    ...
    public class TwoDOF : BapMapper
    {
        ...
        public TwoDOF(Transform bone, BAPType type1, Vector3 axis1, BAPType type2, Vector3 axis2) : this(bone,
            Quaternion.identity, type1, axis1, type2, axis2)
        {
        }

        public TwoDOF(Transform bone, Quaternion correction, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2) : base(bone, correction)
        {
            this.type1 = type1;
            this.axis1 = axis1;
            lastVal1 = 0;
        ...
        public override Quaternion getRotation(AnimationParametersFrame bf)
        {
            var q1 = newQuaternion(axis1, lastVal1);
            var q2 = newQuaternion(axis2, lastVal2);
            return q2 * q1;
        }
    }
    ...
    public class ThreeDOF : TwoDOF
    {
        ...
        public ThreeDOF(Transform bone, BAPType type1, Vector3 axis1, BAPType type2, Vector3 axis2, BAPType type3,
            Vector3 axis3) :
            this(bone, Quaternion.identity, type1, axis1, type2, axis2, type3, axis3)
        {
        }

        public ThreeDOF(Transform bone, Quaternion correction, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3) :
        ...
        public override bool needsUpdate(AnimationParametersFrame bf)
        {
            var toReturn = base.needsUpdate(bf);
            if (bf.getMask(type3))
            {
        ...
        public override Quaternion getRotation(AnimationParametersFrame bf)
        {
            var q1 = newQuaternion(axis1, lastVal1);
            var q2 = newQuaternion(axis2, lastVal2);
            var q3 = newQuaternion(axis3, lastVal3);
    ...
    public class TwistMapper : ThreeDOF
    {
        ...
        protected double twistFactor;

        public TwistMapper(Transform bone, Transform twistBone, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3, double twistFactor) :
        ...
        public override bool needsUpdate(AnimationParametersFrame bf)
        {
            var update = base.needsUpdate(bf);
        ...
        public override Quaternion getRotation(AnimationParametersFrame bf)
        {
            var original = base.getRotation(bf);
    ...
    public class YawTwistMapper : TwistMapper
    {
        ...
        public YawTwistMapper(Transform bone, Transform twistBone, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3, double twistFactor) :
        ...
        {
            var fTx = 2.0 * originalRotation.x;
            var fTy = 2.0 * originalRotation.y;
            var fTz = 2.0 * originalRotation.z;
            var fTwy = fTy * originalRotation.w;
            var fTxx = fTx * originalRotation.x;
            var fTxz = fTz * originalRotation.x;
            var fTyy = fTy * originalRotation.y;
            var yaw = Math.Atan2(fTxz + fTwy, 1.0 - (fTxx + fTyy)) * twistFactor;
    ...
    {
        public YawTwistBeforeMapper(Transform bone, Transform twistBone, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3, double twistFactor) :
            base(bone, twistBone, type1, axis1, type2, axis2, type3, axis3, twistFactor)
        {
        }
    ...
    {
        public YawTwistAfterMapper(Transform bone, Transform twistBone, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3, double twistFactor) :
            base(bone, twistBone, type1, axis1, type2, axis2, type3, axis3, twistFactor)
        {
        }
    ...
    public class ThreeDOFScaled : ThreeDOF
    {
        ...
        public ThreeDOFScaled(Transform bone, BAPType type1, Vector3 axis1, BAPType type2, Vector3 axis2, BAPType type3,
            Vector3 axis3) :
            this(bone, Quaternion.identity, type1, axis1, type2, axis2, type3, axis3)
        {
        }

        public ThreeDOFScaled(Transform bone, Quaternion correction, BAPType type1, Vector3 axis1, BAPType type2,
            Vector3 axis2, BAPType type3, Vector3 axis3) :
        ...
        public override Quaternion getRotation(AnimationParametersFrame bf)
        {
            var q1 = newQuaternion(axis1, lastVal1 * scale);
            var q2 = newQuaternion(axis2, lastVal2 * scale);
            var q3 = newQuaternion(axis3, lastVal3 * scale);
